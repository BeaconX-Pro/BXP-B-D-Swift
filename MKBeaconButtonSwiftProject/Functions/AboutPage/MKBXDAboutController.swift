...
public final class MKBXDAboutController: MKSwiftBaseViewController {

    // MARK: - Subviews

    private lazy var aboutIcon: UIImageView = {
        let iv = UIImageView()
        iv.image = UIImage(named: "bxd_about_logo.png")   // ⚠️ 按工程图标 API 调整
        return iv
    }()
    ...
    private lazy var bottomIcon: UIImageView = {
        ...
        iv.image = UIImage(named: "bxd_aboutBottomIcon.png")
        return iv
    }()
    ...
    private func loadSubViews() {
        ...
        let imageSize = UIImage(named: "bxd_aboutBottomIcon.png")?.size ?? .zero
